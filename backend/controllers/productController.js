...
exports.createProduct = async (req, res) => {
  ...
  try {
    ...
    const result = await pool.query(
      ...
      [name, category, restaurant_id, price, commission, status, imagesArray, variantsArray]
    );
...
exports.updateProduct = async (req, res) => {
  ...
  try {
    ...
    const result = await pool.query(
      ...
      [name, category, restaurant_id, price, commission, status, imagesArray, variantsArray, id]
    );
