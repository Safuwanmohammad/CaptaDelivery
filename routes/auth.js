  ...
  try {
    ...
    if (!apiKey) {
      ...
      return { 
        ...
        details: 'Please add TWO_FACTOR_API_KEY to your .env file'
      };
    }
    ...
    if (err.response) {
      ...
      console.error('  No response received from 2Factor API');
      return { 
        success: false, 
        error: 'No response from 2Factor API. Check your internet connection.',
